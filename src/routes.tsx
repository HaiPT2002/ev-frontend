...
const routes = [
  ...
  { path: 'contracts', element: <ContractsList />, roles: ['ADMIN', 'EVM_STAFF', 'DEALER_MANAGER', 'DEALER_STAFF'] },
  { path: 'contracts/:id', element: <ContractDetail />, roles: ['ADMIN', 'EVM_STAFF', 'DEALER_MANAGER', 'DEALER_STAFF'] },

  // Customers: restrict to staff/dealers
  { path: 'customers', element: <CustomersList />, roles: ['ADMIN', 'EVM_STAFF', 'DEALER_MANAGER', 'DEALER_STAFF'] },
  { path: 'customers/:phone', element: <CustomerDetail />, roles: ['ADMIN', 'EVM_STAFF', 'DEALER_MANAGER', 'DEALER_STAFF'] },

  // Test drives: dealer-scoped
  { path: 'testdrives', element: <TestDrives />, roles: ['DEALER_MANAGER', 'DEALER_STAFF'] },
  { path: 'testdrives/create', element: <TestDriveCreate />, roles: ['DEALER_MANAGER', 'DEALER_STAFF'] },
  ...
  { path: 'payments/create', element: <PaymentsCreate />, roles: ['ADMIN', 'EVM_STAFF', 'DEALER_MANAGER', 'DEALER_STAFF'] },
  { path: 'payments', element: <PaymentsList />, roles: ['ADMIN', 'EVM_STAFF', 'DEALER_MANAGER', 'DEALER_STAFF'] },
